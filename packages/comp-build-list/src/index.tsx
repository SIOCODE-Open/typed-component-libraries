...
export type BuildListField = "buildNumber" | "date" | "status";

/** Props for the BuildList component */
...
export const BUILD_LIST_FIELD_NAMES = {
...
/** Shows a Build list */
export function BuildList(props: IBuildListProps) {
    ...
    return (
        <div className="flex flex-row justify-start items-center">
            <div className="bg-gray-600 text-white px-2 py-1 rounded-l-lg">
                {BUILD_LIST_FIELD_NAMES[props.field]}
            </div>
