...
export type ReviewDetailField = "id" | "productSku" | "rating" | "comment";

/** Props for the ReviewDetail component */
...
export const REVIEW_DETAIL_FIELD_NAMES = {
    id: "Id",
...
/** Shows a Review detail */
export function ReviewDetail(props: IReviewDetailProps) {
    ...
    return (
        <div className="flex flex-row justify-start items-center">
            <div className="bg-gray-600 text-white px-2 py-1 rounded-l-lg">
                {REVIEW_DETAIL_FIELD_NAMES[props.field]}
            </div>
