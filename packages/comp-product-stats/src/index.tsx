...
/** Props for the ProductStats component */
...
export const PRODUCT_STATS_FIELD_NAMES = {
    sku: "Sku",
    name: "Name",
...
/** Shows a Product stats */
export function ProductStats(props: IProductStatsProps) {
    ...
    return (
        <div className="flex flex-row justify-start items-center">
            <div className="bg-gray-600 text-white px-2 py-1 rounded-l-lg">
                {PRODUCT_STATS_FIELD_NAMES[props.field]}
            </div>
