...
export type SupplierCardField = "id" | "name" | "contactEmail" | "active";
...
export const SUPPLIER_CARD_FIELD_NAMES = {
    id: "Id",
    name: "Name",
...
/** Shows a Supplier card */
export function SupplierCard(props: ISupplierCardProps) {
    ...
    return (
        <div className="flex flex-row justify-start items-center">
            <div className="bg-gray-600 text-white px-2 py-1 rounded-l-lg">
                {SUPPLIER_CARD_FIELD_NAMES[props.field]}
            </div>
