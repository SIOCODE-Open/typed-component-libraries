...
export type ReviewFormField = "id" | "productSku" | "rating" | "comment";
...
export const REVIEW_FORM_FIELD_NAMES = {
    id: "Id",
...
/** Shows a Review form */
export function ReviewForm(props: IReviewFormProps) {
    ...
    return (
        <div className="flex flex-row justify-start items-center">
            <div className="bg-gray-600 text-white px-2 py-1 rounded-l-lg">
                {REVIEW_FORM_FIELD_NAMES[props.field]}
            </div>
