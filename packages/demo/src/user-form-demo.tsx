...
const USER_FORM_FIELD_NAMES_LIST = Object.keys(
    USER_FORM_FIELD_NAMES
) as Array<UserFormField>;
...
export function UserFormDemo() {
    const [demoField, setDemoField] = useState<UserFormField>(
        USER_FORM_FIELD_NAMES_LIST[0]
    );
        ...
        <div className="flex flex-col justify-start items-center gap-2">
            ...
            <div className="flex flex-row justify-start items-center gap-2">
                ...
                <select
                    value={demoField}
                    onChange={(e) =>
                        setDemoField(e.target.value as UserFormField)
                    }
                >
                    {USER_FORM_FIELD_NAMES_LIST.map((field) => (
                        <option key={field} value={field}>
                            {USER_FORM_FIELD_NAMES[field]}
                        </option>
                    ))}
                </select>
            </div>
