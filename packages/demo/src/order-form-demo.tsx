...
const ORDER_FORM_FIELD_NAMES_LIST = Object.keys(
    ORDER_FORM_FIELD_NAMES
) as Array<OrderFormField>;
...
export function OrderFormDemo() {
    const [demoField, setDemoField] = useState<OrderFormField>(
        ORDER_FORM_FIELD_NAMES_LIST[0]
    );
        ...
        <div className="flex flex-col justify-start items-center gap-2">
            ...
            <div className="flex flex-row justify-start items-center gap-2">
                ...
                <select
                    value={demoField}
                    onChange={(e) =>
                        setDemoField(e.target.value as OrderFormField)
                    }
                >
                    {ORDER_FORM_FIELD_NAMES_LIST.map((field) => (
                        <option key={field} value={field}>
                            {ORDER_FORM_FIELD_NAMES[field]}
                        </option>
                    ))}
                </select>
            </div>
