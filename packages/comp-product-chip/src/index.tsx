...
/** Props for the ProductChip component */
export interface IProductChipProps {
...
export const PRODUCT_CHIP_FIELD_NAMES = {
    sku: "Sku",
    name: "Name",
...
/** Shows a Product chip */
export function ProductChip(props: IProductChipProps) {
    ...
    return (
        <div className="flex flex-row justify-start items-center">
            <div className="bg-gray-600 text-white px-2 py-1 rounded-l-lg">
                {PRODUCT_CHIP_FIELD_NAMES[props.field]}
            </div>
