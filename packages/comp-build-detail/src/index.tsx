...
export type BuildDetailField = "buildNumber" | "date" | "status";

/** Props for the BuildDetail component */
export interface IBuildDetailProps {
...
export const BUILD_DETAIL_FIELD_NAMES = {
    buildNumber: "Build Number",
    date: "Date",
    status: "Status",
};

/** Shows a Build detail */
export function BuildDetail(props: IBuildDetailProps) {
    ...
    return (
        <div className="flex flex-row justify-start items-center">
            <div className="bg-gray-600 text-white px-2 py-1 rounded-l-lg">
                {BUILD_DETAIL_FIELD_NAMES[props.field]}
            </div>
