...
export type ReviewSummaryField = "id" | "productSku" | "rating" | "comment";
...
export const REVIEW_SUMMARY_FIELD_NAMES = {
    id: "Id",
...
export function ReviewSummary(props: IReviewSummaryProps) {
    ...
    return (
        <div className="flex flex-row justify-start items-center">
            <div className="bg-gray-600 text-white px-2 py-1 rounded-l-lg">
                {REVIEW_SUMMARY_FIELD_NAMES[props.field]}
            </div>
