...
export type BuildStatsField = "buildNumber" | "date" | "status";

/** Props for the BuildStats component */
export interface IBuildStatsProps {
...
export const BUILD_STATS_FIELD_NAMES = {
...
/** Shows a Build stats */
export function BuildStats(props: IBuildStatsProps) {
    ...
    return (
        <div className="flex flex-row justify-start items-center">
            <div className="bg-gray-600 text-white px-2 py-1 rounded-l-lg">
                {BUILD_STATS_FIELD_NAMES[props.field]}
            </div>
